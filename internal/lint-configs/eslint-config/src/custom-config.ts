...
const customConfig: Linter.Config[] = [
                    ...
                    patterns: [
                        {
                            group: ['@dag/*'],
                            message:
                                'The @core package cannot import the @dag package, please use the @core package itself'
                        }
                    ]
                }
            ]
    ...
    {
        // @core/shared内部组件，不能引入@dag/* 或者 @dag-core/* 里面的包
                    ...
                    patterns: [
                        {
                            group: ['@dag/*', '@dag-core/*'],
                            message:
                                'The @dag-core/shared package cannot import the @dag package, please use the @core/shared package itself'
                        }
                    ]
                }
            ]
                    ...
                    patterns: [
                        {
                            group: ['@dag/*'],
                            message:
                                'The @dag package cannot be imported, please use the @core package itself'
                        }
                    ]
                }
            ]
