...
<template>
    <div class="p-5">
        <WorkbenchHeader :avatar="userStore.userInfo?.avatar || preferences.app.defaultAvatar">
            ...
            <template #description> 今日晴，今日晴，20℃ - 32℃！ </template>
        </WorkbenchHeader>

        <div class="mt-5 flex flex-col lg:flex-row">
            <div class="mr-4 w-full lg:w-3/5">
                <WorkbenchProject :items="projectItems" title="项目" />
                <WorkbenchTrends :items="trendItems" title="最新动态" class="mt-5" />
            </div>
            <div class="w-full lg:w-2/5">
                <WorkbenchQuickNav :items="quickNavItems" title="快捷导航" />
                <WorkbenchTodo :items="todoItems" title="待办事项" class="mt-5" />
                <AnalysisChartCard title="访问来源" class="mt-5">
