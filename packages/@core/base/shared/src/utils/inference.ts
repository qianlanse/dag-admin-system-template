...
function isMacOs(): boolean {
    ...
    return macRegexp.test(navigator.userAgent)
}
...
function isWindowsOs(): boolean {
    const windowsRegexp = /windows|win32/i
    return windowsRegexp.test(navigator.userAgent)
}
...
/**
 * 返回既不是“null”也不是“undefined”列表中的第一个值
 */
