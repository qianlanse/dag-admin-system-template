...
import type { DagButtonProps } from '@dag-core/shadcn-ui'
import type { ClassType, MaybeComputedRef } from '@dag-core/typings'
...
export type MaybeComponentPropsKey =
    | 'options'
    | 'placeholder'
    | 'title'
...
export type MaybeComponentProps = { [K in MaybeComponentPropsKey]?: any }
...
/** 单个表单项的props */
type ComponentProps =
    | ((value: Partial<Record<string, any>>, options: FormActions) => MaybeComponentProps)
    | MaybeComponentProps
...
export interface ActionButtonOptions extends DagButtonProps {
    [key: string]: any
...
export interface DagFormProps<T extends BaseFormComponentType = BaseFormComponentType>
