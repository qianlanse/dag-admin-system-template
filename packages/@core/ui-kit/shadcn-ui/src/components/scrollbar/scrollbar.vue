...
<template>
    ...
    >
        ...
        <div
            ...
            class="scrollbar-bottom-shadow pointer-events-none absolute bottom-0 z-10 w-full opacity-0 transition-opacity duration-300 ease-in-out will-change-[opacity]"
        ></div>
