<script setup lang="ts">
    ...
    import { CSS_VARIABLE_LAYOUT_CONTENT_HEIGHT } from '@dag-core/shared/constants'
...
<template>
    <div class="relative">
        <div
            ...
            ref="headerRef"
            :class="
                cn('bg-card border-border relative flex items-end border-b px-6 py-4', headerClass)
            "
        >
            <div class="flex-auto">
                <slot name="title">
