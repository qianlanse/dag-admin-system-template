<script setup lang="ts">
    import { DagAvatar } from '@dag-core/shadcn-ui'
...
<template>
    <div class="card-box px-4 py-6 lg:flex">
        <DagAvatar :src="avatar" class="size-20" />
        <div
            v-if="$slots.title || $slots.description"
            class="mt-3 flex flex-col justify-center md:ml-6 md:mt-0"
        >
