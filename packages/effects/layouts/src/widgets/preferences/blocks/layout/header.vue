<script setup lang="ts">
    import type { LayoutHeaderMenuAlignType, LayoutHeaderModeType, SelectOption } from '@dag/types'
    ...
    const headerMenuItems: SelectOption[] = [
        {
...
<template>
    ...
    <SelectItem v-model="headerMode" :disabled="!headerEnable" :items="headerMenuItems">
        {{ $t('preferences.mode') }}
    </SelectItem>
