...
import { preferences } from '@dag-core/preferences'
import { openRouteInNewWindow, startProgress, stopProgress } from '@dag-core/shared/utils'
    ...
    actions: {
        ...
        async closeTab(tab: TabDefinition, router: Router) {
            ...
            if (after) {
                ...
                console.error('关闭选项卡失败;只有一个选项卡保持打开状态;')
            }
        },
        ...
        addTab(routeTab: TabDefinition): TabDefinition {
            ...
            const tabIndex = this.tabs.findIndex((item) => equalTab(item, tab))
